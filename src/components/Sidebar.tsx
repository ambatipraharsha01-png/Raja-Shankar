...
import { 
    PhoneIcon, BriefcaseIcon, InformationCircleIcon, UsersIcon, BookOpenIcon, 
    AcademicCapIcon, LibraryIcon, SettingsIcon, LogoutIcon, DocumentTextIcon, 
    BuildingLibraryIcon, TrophyIcon, CalendarDaysIcon
} from './icons';
...
const menuItems = [
    ...
    { icon: <CalendarDaysIcon />, name: 'Exam Schedule', view: 'exam_schedule' },
];
